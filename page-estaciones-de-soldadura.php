<?php
/**
 * Template Name: Página de Estaciones de Soldadura
 * 
 * Template para mostrar productos de estaciones-de-soldadura
 */

get_header();

// Agregar metadata SEO específica para estaciones-de-soldadura
add_action('wp_head', function() {
    echo '<meta name="description" content="Estaciones de soldadura profesionales para reparación de celulares y electrónica. Estaciones de aire caliente, soldadura digital, equipos con control de temperatura para técnicos especializados.">' . "\n";
    echo '<meta name="keywords" content="estacion soldadura, estacion aire caliente, soldadura digital, estacion desoldadura, rework station, estacion soldadura SMD, reparacion celulares, soldadura electronica">' . "\n";
    echo '<meta property="og:title" content="Estaciones de Soldadura Profesionales - ITOOLS">' . "\n";
    echo '<meta property="og:description" content="Estaciones de soldadura profesionales con control de temperatura, aire caliente y equipos especializados para reparación de celulares">' . "\n";
    ...
    if (has_post_thumbnail()) {
        ...
        if ($thumbnail_url) {
            ...
            echo '<meta property="og:image:alt" content="Estaciones de Soldadura - ITOOLS">' . "\n";
        }
    }
    ...
    echo json_encode(array(
        ...
        "@type" => "CollectionPage",
        "name" => "Estaciones de Soldadura Profesionales",
        "description" => "Estaciones de soldadura y desoldadura profesionales para reparación de celulares y electrónica. Equipos con aire caliente, control digital de temperatura y accesorios especializados.",
        "url" => get_permalink(),
...
$_GET['s'] = 'estaciones-de-soldadura';
...
// Debug: Mostrar información de la consulta si estamos en modo debug
if (defined('WP_DEBUG') && WP_DEBUG) {
    error_log('Estaciones de Soldadura Query Args: ' . print_r($args, true));
    error_log('Found Posts: ' . $products_query->found_posts);
    error_log('URL Parameters: ' . print_r($_GET, true));
}
...
<div class="relative bg-gradient-to-br from-blue-50 via-indigo-50 to-white border-b border-blue-100">
    ...
    <!-- Contenido -->
    <div class="relative max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14 lg:py-16">
        <div class="text-center">
            ...
            <p class="text-lg text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
                Estaciones de soldadura profesionales para reparación de celulares y dispositivos electrónicos. Equipos de calidad con control de temperatura
            </p>
                    ...
                    <div method="get" action="<?php echo esc_url( home_url( '/' ) ); ?>" class="flex flex-col sm:flex-row">
                        ...
                        <div class="flex-1 relative ">
                            ...
                            <input type="text" 
                                   ...
                                   placeholder="Buscar estaciones de soldadura por modelo o características..."
...
<div class="bg-white border-b border-gray-100">
    <div class="w-11/12 py-4 mx-auto 2xl:max-w-[1920px] px-6">
        <nav class="flex items-center space-x-2 text-sm">
            ...
            <span class="text-gray-900 font-semibold">Estaciones de Soldadura</span>
        </nav>
    </div>
</div>
            ...
            <div class="flex flex-col lg:flex-row gap-6">
                ...
                <main class="flex-1 w-full xl:w-auto">
                    ...
                    <div class="mt-12">
                        ...
                        function estaciones_de_soldadura_custom_pagination($query) {
                            if ($query->max_num_pages <= 1) return;
                            
                            $paged = get_query_var('paged') ? absint(get_query_var('paged')) : 1;
                            $max_pages = $query->max_num_pages;
                            
                            // URL base fija para la página de estaciones-de-soldadura
                            $base_url = home_url('/estaciones-de-soldadura/');
                        ...
                        estaciones_de_soldadura_custom_pagination($products_query);
                        ?>
                    </div>

...
<button onclick="openTally()" 
   ...
   ">
    ...
    <svg width="32" height="32" viewBox="0 0 24 24" fill="currentColor" style="color: #ffffff; width: 32px !important; height: 32px !important; min-width: 32px !important; min-height: 32px !important; flex-shrink: 0 !important;">

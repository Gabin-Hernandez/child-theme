            ...
            <div class="nav-row" style="border-top: 1px solid #f3f4f6; padding: 12px 0;">
                <nav style="display: flex; align-items: center; justify-content: center; gap: 40px;">
                    ...
                    <div class="dropdown-container" style="position: relative;">
                        ...
                        <div class="dropdown-menu" style="position: absolute; top: 100%; left: 0; background: white; border: 1px solid #e5e7eb; border-radius: 8px; box-shadow: 0 10px 25px rgba(0,0,0,0.1); min-width: 200px; opacity: 0; visibility: hidden; transform: translateY(-10px); transition: all 0.2s; z-index: 1000;">
                            <a href="https://lightblue-gull-856657.hostingersite.com/categoria/herramientas/" style="display: block; padding: 12px 16px; color: #374151; text-decoration: none; border-bottom: 1px solid #f3f4f6; transition: background 0.2s;">Microscopios</a>
                            <a href="https://lightblue-gull-856657.hostingersite.com/categoria/herramientas/" style="display: block; padding: 12px 16px; color: #374151; text-decoration: none; border-bottom: 1px solid #f3f4f6; transition: background 0.2s;">Estaciones de Soldadura</a>
                            <a href="https://lightblue-gull-856657.hostingersite.com/categoria/herramientas/" style="display: block; padding: 12px 16px; color: #374151; text-decoration: none; border-bottom: 1px solid #f3f4f6; transition: background 0.2s;">Cautines</a>
                            <a href="https://lightblue-gull-856657.hostingersite.com/categoria/herramientas/" style="display: block; padding: 12px 16px; color: #374151; text-decoration: none; border-bottom: 1px solid #f3f4f6; transition: background 0.2s;">Destornilladores</a>
                    ...
                    <div class="dropdown-container" style="position: relative;">
                        ...
                        <div class="dropdown-menu" style="position: absolute; top: 100%; left: 0; background: white; border: 1px solid #e5e7eb; border-radius: 8px; box-shadow: 0 10px 25px rgba(0,0,0,0.1); min-width: 200px; opacity: 0; visibility: hidden; transform: translateY(-10px); transition: all 0.2s; z-index: 1000;">
                            <a href="https://lightblue-gull-856657.hostingersite.com/categoria/apple/" style="display: block; padding: 12px 16px; color: #374151; text-decoration: none; border-bottom: 1px solid #f3f4f6; transition: background 0.2s;">🍎 Apple</a>
                            <a href="https://lightblue-gull-856657.hostingersite.com/categoria/samsung/" style="display: block; padding: 12px 16px; color: #374151; text-decoration: none; border-bottom: 1px solid #f3f4f6; transition: background 0.2s;">📱 Samsung</a>
                            <a href="https://lightblue-gull-856657.hostingersite.com/categoria/huawei/" style="display: block; padding: 12px 16px; color: #374151; text-decoration: none; border-bottom: 1px solid #f3f4f6; transition: background 0.2s;">📲 Huawei</a>
                            <a href="https://lightblue-gull-856657.hostingersite.com/categoria/xiaomi/" style="display: block; padding: 12px 16px; color: #374151; text-decoration: none; border-bottom: 1px solid #f3f4f6; transition: background 0.2s;">🎯 Xiaomi</a>
                            <a href="https://lightblue-gull-856657.hostingersite.com/categoria/motorola/" style="display: block; padding: 12px 16px; color: #374151; text-decoration: none; border-bottom: 1px solid #f3f4f6; transition: background 0.2s;">📞 Motorola</a>
                    ...
                    <a href="https://lightblue-gull-856657.hostingersite.com/ofertas/" style="padding: 8px 12px; color: #dc2626; font-weight: 600; text-decoration: none; border-radius: 6px; transition: all 0.2s;">
                        🏷️ Ofertas
                    </a>
                </nav>
            </div>
        ...
        <div style="max-width: 1200px; margin: 0 auto; padding: 20px;">
            ...
            <div style="display: flex; flex-direction: column; gap: 16px;">
                ...
                <div>
                    ...
                    <div style="display: flex; flex-direction: column; gap: 8px; margin-left: 16px;">
                        <a href="https://lightblue-gull-856657.hostingersite.com/categoria/herramientas/" style="color: #6b7280; text-decoration: none; font-size: 14px;">Microscopios</a>
                        <a href="https://lightblue-gull-856657.hostingersite.com/categoria/herramientas/" style="color: #6b7280; text-decoration: none; font-size: 14px;">Estaciones de Soldadura</a>
                        <a href="https://lightblue-gull-856657.hostingersite.com/categoria/herramientas/" style="color: #6b7280; text-decoration: none; font-size: 14px;">Cautines</a>
                ...
                <div>
                    ...
                    <div style="display: flex; flex-direction: column; gap: 8px; margin-left: 16px;">
                        <a href="https://lightblue-gull-856657.hostingersite.com/categoria/apple/" style="color: #6b7280; text-decoration: none; font-size: 14px;">🍎 Apple</a>
                        <a href="https://lightblue-gull-856657.hostingersite.com/categoria/samsung/" style="color: #6b7280; text-decoration: none; font-size: 14px;">📱 Samsung</a>
                        <a href="https://lightblue-gull-856657.hostingersite.com/categoria/huawei/" style="color: #6b7280; text-decoration: none; font-size: 14px;">📲 Huawei</a>
                ...
                <div style="border-top: 1px solid #e5e7eb; padding-top: 16px;">
                    ...
                    <a href="https://lightblue-gull-856657.hostingersite.com/ofertas/" style="display: block; padding: 12px 0; color: #dc2626; font-weight: 600; text-decoration: none;">🏷️ Ofertas</a>
                </div>
            </div>
        </div>
    </div>

            ...
            <div style="display: flex; flex-direction: column; gap: 0;">
                ...
                <div style="border-bottom: 1px solid #f3f4f6;">
                    ...
                    <div id="herramientas-content" style="display: none; padding: 0 0 16px 52px;">
                        <div style="display: flex; flex-direction: column; gap: 12px;">
                            <a href="<?php echo esc_url( home_url( '/?s=microscopios&post_type=product' ) ); ?>" style="color: #4b5563; text-decoration: none; font-size: 14px; padding: 8px 0; border-bottom: 1px solid #f9fafb;">Microscopios</a>
                            <a href="<?php echo esc_url( home_url( '/?s=estaciones+de+soldadura&post_type=product' ) ); ?>" style="color: #4b5563; text-decoration: none; font-size: 14px; padding: 8px 0; border-bottom: 1px solid #f9fafb;">Estaciones de Soldadura</a>
                            <a href="<?php echo esc_url( home_url( '/?s=cautines&post_type=product' ) ); ?>" style="color: #4b5563; text-decoration: none; font-size: 14px; padding: 8px 0;">Cautines</a>
                        </div>
                    </div>
                </div>
                ...
                <div style="border-bottom: 1px solid #f3f4f6;">
                    ...
                    <div id="marcas-content" style="display: none; padding: 0 0 16px 52px;">
                        <div style="display: flex; flex-direction: column; gap: 12px;">
                            <a href="<?php echo esc_url( home_url( '/?s=apple&post_type=product' ) ); ?>" style="display: flex; align-items: center; gap: 8px; color: #4b5563; text-decoration: none; font-size: 14px; padding: 8px 0; border-bottom: 1px solid #f9fafb;">
                                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                                    <path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.81-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M13 3.5c.73-.83 1.94-1.46 2.94-1.5.13 1.17-.34 2.35-1.04 3.19-.69.85-1.83 1.51-2.95 1.42-.15-1.15.41-2.35 1.05-3.11z"/>
                                </svg>
                                Apple
                            </a>
                            <a href="<?php echo esc_url( home_url( '/?s=samsung&post_type=product' ) ); ?>" style="display: flex; align-items: center; gap: 8px; color: #4b5563; text-decoration: none; font-size: 14px; padding: 8px 0; border-bottom: 1px solid #f9fafb;">
                                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                                    <path d="M22.86 5.82v12.36c0 3.21-2.61 5.82-5.82 5.82H6.96c-3.21 0-5.82-2.61-5.82-5.82V5.82C1.14 2.61 3.75 0 6.96 0h10.08c3.21 0 5.82 2.61 5.82 5.82z"/>
                                </svg>
                                Samsung
                            </a>
                            <a href="<?php echo esc_url( home_url( '/?s=huawei&post_type=product' ) ); ?>" style="display: flex; align-items: center; gap: 8px; color: #4b5563; text-decoration: none; font-size: 14px; padding: 8px 0;">
                                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                                    <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/>
                                </svg>
                                Huawei

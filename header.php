...
<div id="page" class="site">
    ...
    <header id="main-header" style="background: #171717; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.3); transition: all 0.3s ease;">
        <div>
                ...
                <div class="header-row flex w-9/12 px-4 items-center justify-between">
            ...
            <div class="flex">
                <div class="header-search flex-1 min-w-[300px] xl:min-w-[600px] " style="margin: 20px 40px 0 40px; position: relative;"> 

...
<div id="page" class="site">
    ...
    <header id="main-header" style="background: #171717; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.3); transition: all 0.3s ease;">
        <div>
                ...
                <div class="header-row flex w-11/12 2xl:w-7/12 mx-auto items-center justify-between">
            ...
            <div class="nav-row" style="border-top: 1px solid rgba(255,255,255,0.1); padding: 12px 0;">
                <div style="margin: 0 auto; padding: 0 20px;" class="max-w-7xl">
                    ...
                    <div class="dropdown-container" style="position: relative;">
                        ...
                        <div class="dropdown-menu" style="position: absolute; top: 100%; left: 0; background: white; border: 1px solid #e5e7eb; border-radius: 8px; box-shadow: 0 10px 25px rgba(0,0,0,0.1); min-width: 200px; opacity: 0; visibility: hidden; transform: translateY(-10px); transition: all 0.2s; z-index: 1000;">
                            <a href="<?php echo esc_url( home_url( '/apple/' ) ); ?>" style="display: flex; align-items: center; gap: 8px; padding: 12px 16px; color: #374151; text-decoration: none; border-bottom: 1px solid #f3f4f6; transition: background 0.2s;">
                                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                                    <path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.81-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M13 3.5c.73-.83 1.94-1.46 2.94-1.5.13 1.17-.34 2.35-1.04 3.19-.69.85-1.83 1.51-2.95 1.42-.15-1.15.41-2.35 1.05-3.11z"/>
                                </svg>
                                Apple
                            </a>
                            <a href="<?php echo esc_url( home_url( '/samsung/' ) ); ?>" style="display: flex; align-items: center; gap: 8px; padding: 12px 16px; color: #374151; text-decoration: none; border-bottom: 1px solid #f3f4f6; transition: background 0.2s;">
                                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                            ...
                            <a href="<?php echo esc_url( home_url( '/huawei/' ) ); ?>" style="display: flex; align-items: center; gap: 8px; padding: 12px 16px; color: #374151; text-decoration: none; border-bottom: 1px solid #f3f4f6; transition: background 0.2s;">
                                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                                    <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/>
                                </svg>
                                Huawei
                            </a>
                            <a href="<?php echo esc_url( home_url( '/xiaomi/' ) ); ?>" style="display: flex; align-items: center; gap: 8px; padding: 12px 16px; color: #374151; text-decoration: none; border-bottom: 1px solid #f3f4f6; transition: background 0.2s;">
                                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                            ...
                            <a href="<?php echo esc_url( home_url( '/motorola/' ) ); ?>" style="display: flex; align-items: center; gap: 8px; padding: 12px 16px; color: #374151; text-decoration: none; border-bottom: 1px solid #f3f4f6; transition: background 0.2s;">
                                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        <div class="dropdown-menu" style="position: absolute; top: 100%; left: -400px; background: white; border: 1px solid #e5e7eb; border-radius: 12px; box-shadow: 0 20px 25px -5px rgba(0,0,0,0.1), 0 10px 10px -5px rgba(0,0,0,0.04); min-width: 800px; opacity: 0; visibility: hidden; transform: translateY(-10px); transition: all 0.3s; z-index: 1000; padding: 20px;">
                            ...
                            <div class="mega-menu-grid" style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 30px;">
                                ...
                                <div>
                                    ...
                                    <div style="display: flex; flex-direction: column; gap: 8px;">
                                        <a href="<?php echo esc_url( home_url( '/galaxy-s24-ultra/' ) ); ?>" style="color: #4b5563; text-decoration: none; padding: 8px 12px; border-radius: 6px; transition: all 0.2s; font-size: 14px; font-weight: 500;" onmouseover="this.style.backgroundColor='#f3f4f6'; this.style.color='#2563eb'" onmouseout="this.style.backgroundColor='transparent'; this.style.color='#4b5563'">Galaxy S24 Ultra</a>
                                        <a href="<?php echo esc_url( home_url( '/galaxy-s24-plus/' ) ); ?>" style="color: #4b5563; text-decoration: none; padding: 8px 12px; border-radius: 6px; transition: all 0.2s; font-size: 14px; font-weight: 500;" onmouseover="this.style.backgroundColor='#f3f4f6'; this.style.color='#2563eb'" onmouseout="this.style.backgroundColor='transparent'; this.style.color='#4b5563'">Galaxy S24 Plus</a>
                                        <a href="<?php echo esc_url( home_url( '/galaxy-s24/' ) ); ?>" style="color: #4b5563; text-decoration: none; padding: 8px 12px; border-radius: 6px; transition: all 0.2s; font-size: 14px; font-weight: 500;" onmouseover="this.style.backgroundColor='#f3f4f6'; this.style.color='#2563eb'" onmouseout="this.style.backgroundColor='transparent'; this.style.color='#4b5563'">Galaxy S24</a>
                                        <a href="<?php echo esc_url( home_url( '/galaxy-s23-ultra/' ) ); ?>" style="color: #4b5563; text-decoration: none; padding: 8px 12px; border-radius: 6px; transition: all 0.2s; font-size: 14px; font-weight: 500;" onmouseover="this.style.backgroundColor='#f3f4f6'; this.style.color='#2563eb'" onmouseout="this.style.backgroundColor='transparent'; this.style.color='#4b5563'">Galaxy S23 Ultra</a>
                                        <a href="<?php echo esc_url( home_url( '/galaxy-s22-ultra/' ) ); ?>" style="color: #4b5563; text-decoration: none; padding: 8px 12px; border-radius: 6px; transition: all 0.2s; font-size: 14px; font-weight: 500;" onmouseover="this.style.backgroundColor='#f3f4f6'; this.style.color='#2563eb'" onmouseout="this.style.backgroundColor='transparent'; this.style.color='#4b5563'">Galaxy S22 Ultra</a>
                                        <a href="<?php echo esc_url( home_url( '/galaxy-a54/' ) ); ?>" style="color: #4b5563; text-decoration: none; padding: 8px 12px; border-radius: 6px; transition: all 0.2s; font-size: 14px; font-weight: 500;" onmouseover="this.style.backgroundColor='#f3f4f6'; this.style.color='#2563eb'" onmouseout="this.style.backgroundColor='transparent'; this.style.color='#4b5563'">Galaxy A54</a>
                                        <a href="<?php echo esc_url( home_url( '/galaxy-a34/' ) ); ?>" style="color: #4b5563; text-decoration: none; padding: 8px 12px; border-radius: 6px; transition: all 0.2s; font-size: 14px; font-weight: 500;" onmouseover="this.style.backgroundColor='#f3f4f6'; this.style.color='#2563eb'" onmouseout="this.style.backgroundColor='transparent'; this.style.color='#4b5563'">Galaxy A34</a>
                                        <a href="<?php echo esc_url( home_url( '/galaxy-a24/' ) ); ?>" style="color: #4b5563; text-decoration: none; padding: 8px 12px; border-radius: 6px; transition: all 0.2s; font-size: 14px; font-weight: 500;" onmouseover="this.style.backgroundColor='#f3f4f6'; this.style.color='#2563eb'" onmouseout="this.style.backgroundColor='transparent'; this.style.color='#4b5563'">Galaxy A24</a>
                                        <a href="<?php echo esc_url( home_url( '/galaxy-note/' ) ); ?>" style="color: #4b5563; text-decoration: none; padding: 8px 12px; border-radius: 6px; transition: all 0.2s; font-size: 14px; font-weight: 500;" onmouseover="this.style.backgroundColor='#f3f4f6'; this.style.color='#2563eb'" onmouseout="this.style.backgroundColor='transparent'; this.style.color='#4b5563'">Galaxy Note</a>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div style="display: flex; flex-direction: column; gap: 8px;">
                                        <a href="<?php echo esc_url( home_url( '/huawei-p60-pro/' ) ); ?>" style="color: #4b5563; text-decoration: none; padding: 8px 12px; border-radius: 6px; transition: all 0.2s; font-size: 14px; font-weight: 500;" onmouseover="this.style.backgroundColor='#f3f4f6'; this.style.color='#2563eb'" onmouseout="this.style.backgroundColor='transparent'; this.style.color='#4b5563'">Huawei P60 Pro</a>
                                        <a href="<?php echo esc_url( home_url( '/huawei-mate-50/' ) ); ?>" style="color: #4b5563; text-decoration: none; padding: 8px 12px; border-radius: 6px; transition: all 0.2s; font-size: 14px; font-weight: 500;" onmouseover="this.style.backgroundColor='#f3f4f6'; this.style.color='#2563eb'" onmouseout="this.style.backgroundColor='transparent'; this.style.color='#4b5563'">Huawei Mate 50</a>
                                        <a href="<?php echo esc_url( home_url( '/huawei-p50-pro/' ) ); ?>" style="color: #4b5563; text-decoration: none; padding: 8px 12px; border-radius: 6px; transition: all 0.2s; font-size: 14px; font-weight: 500;" onmouseover="this.style.backgroundColor='#f3f4f6'; this.style.color='#2563eb'" onmouseout="this.style.backgroundColor='transparent'; this.style.color='#4b5563'">Huawei P50 Pro</a>
                                        <a href="<?php echo esc_url( home_url( '/huawei-p40/' ) ); ?>" style="color: #4b5563; text-decoration: none; padding: 8px 12px; border-radius: 6px; transition: all 0.2s; font-size: 14px; font-weight: 500;" onmouseover="this.style.backgroundColor='#f3f4f6'; this.style.color='#2563eb'" onmouseout="this.style.backgroundColor='transparent'; this.style.color='#4b5563'">Huawei P40</a>
                                        <a href="<?php echo esc_url( home_url( '/honor-90/' ) ); ?>" style="color: #4b5563; text-decoration: none; padding: 8px 12px; border-radius: 6px; transition: all 0.2s; font-size: 14px; font-weight: 500;" onmouseover="this.style.backgroundColor='#f3f4f6'; this.style.color='#2563eb'" onmouseout="this.style.backgroundColor='transparent'; this.style.color='#4b5563'">Honor 90</a>
                                        <a href="<?php echo esc_url( home_url( '/honor-70/' ) ); ?>" style="color: #4b5563; text-decoration: none; padding: 8px 12px; border-radius: 6px; transition: all 0.2s; font-size: 14px; font-weight: 500;" onmouseover="this.style.backgroundColor='#f3f4f6'; this.style.color='#2563eb'" onmouseout="this.style.backgroundColor='transparent'; this.style.color='#4b5563'">Honor 70</a>
                                        <a href="<?php echo esc_url( home_url( '/honor-x9a/' ) ); ?>" style="color: #4b5563; text-decoration: none; padding: 8px 12px; border-radius: 6px; transition: all 0.2s; font-size: 14px; font-weight: 500;" onmouseover="this.style.backgroundColor='#f3f4f6'; this.style.color='#2563eb'" onmouseout="this.style.backgroundColor='transparent'; this.style.color='#4b5563'">Honor X9A</a>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div style="display: flex; flex-direction: column; gap: 8px;">
                                        <a href="<?php echo esc_url( home_url( '/xiaomi-14-ultra/' ) ); ?>" style="color: #4b5563; text-decoration: none; padding: 8px 12px; border-radius: 6px; transition: all 0.2s; font-size: 14px; font-weight: 500;" onmouseover="this.style.backgroundColor='#f3f4f6'; this.style.color='#2563eb'" onmouseout="this.style.backgroundColor='transparent'; this.style.color='#4b5563'">Xiaomi 14 Ultra</a>
                                        <a href="<?php echo esc_url( home_url( '/xiaomi-13-pro/' ) ); ?>" style="color: #4b5563; text-decoration: none; padding: 8px 12px; border-radius: 6px; transition: all 0.2s; font-size: 14px; font-weight: 500;" onmouseover="this.style.backgroundColor='#f3f4f6'; this.style.color='#2563eb'" onmouseout="this.style.backgroundColor='transparent'; this.style.color='#4b5563'">Xiaomi 13 Pro</a>
                                        <a href="<?php echo esc_url( home_url( '/redmi-note-13/' ) ); ?>" style="color: #4b5563; text-decoration: none; padding: 8px 12px; border-radius: 6px; transition: all 0.2s; font-size: 14px; font-weight: 500;" onmouseover="this.style.backgroundColor='#f3f4f6'; this.style.color='#2563eb'" onmouseout="this.style.backgroundColor='transparent'; this.style.color='#4b5563'">Redmi Note 13</a>
                                        <a href="<?php echo esc_url( home_url( '/poco-x6/' ) ); ?>" style="color: #4b5563; text-decoration: none; padding: 8px 12px; border-radius: 6px; transition: all 0.2s; font-size: 14px; font-weight: 500;" onmouseover="this.style.backgroundColor='#f3f4f6'; this.style.color='#2563eb'" onmouseout="this.style.backgroundColor='transparent'; this.style.color='#4b5563'">Poco X6</a>
                                        <a href="<?php echo esc_url( home_url( '/motorola-edge/' ) ); ?>" style="color: #4b5563; text-decoration: none; padding: 8px 12px; border-radius: 6px; transition: all 0.2s; font-size: 14px; font-weight: 500;" onmouseover="this.style.backgroundColor='#f3f4f6'; this.style.color='#2563eb'" onmouseout="this.style.backgroundColor='transparent'; this.style.color='#4b5563'">Motorola Edge</a>
                                        <a href="<?php echo esc_url( home_url( '/oppo/' ) ); ?>" style="color: #4b5563; text-decoration: none; padding: 8px 12px; border-radius: 6px; transition: all 0.2s; font-size: 14px; font-weight: 500;" onmouseover="this.style.backgroundColor='#f3f4f6'; this.style.color='#2563eb'" onmouseout="this.style.backgroundColor='transparent'; this.style.color='#4b5563'">Oppo</a>
                                        <a href="<?php echo esc_url( home_url( '/vivo/' ) ); ?>" style="color: #4b5563; text-decoration: none; padding: 8px 12px; border-radius: 6px; transition: all 0.2s; font-size: 14px; font-weight: 500;" onmouseover="this.style.backgroundColor='#f3f4f6'; this.style.color='#2563eb'" onmouseout="this.style.backgroundColor='transparent'; this.style.color='#4b5563'">Vivo</a>
                                    </div>
                                </div>

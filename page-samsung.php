<?php
/**
 * Template Name: Página de Productos Samsung
 * 
 * Template para mostrar productos de samsung
 */

get_header();

// Agregar metadata SEO específica para samsung
add_action('wp_head', function() {
    echo '<meta name="description" content="Repuestos y accesorios para Samsung Galaxy. Pantallas AMOLED, baterías, cámaras, carcasas y componentes originales y compatibles para reparación de celulares Samsung.">' . "\n";
    echo '<meta name="keywords" content="repuestos samsung, pantalla samsung galaxy, bateria samsung, repuestos galaxy, accesorios samsung, reparacion samsung, pantalla amoled, componentes samsung">' . "\n";
    echo '<meta property="og:title" content="Repuestos y Accesorios para Samsung Galaxy - ITOOLS">' . "\n";
    echo '<meta property="og:description" content="Encuentra repuestos originales y compatibles para Samsung Galaxy. Pantallas AMOLED, baterías, cámaras y componentes de calidad">' . "\n";
    ...
    if (has_post_thumbnail()) {
        ...
        if ($thumbnail_url) {
            ...
            echo '<meta property="og:image:alt" content="Repuestos Samsung - ITOOLS">' . "\n";
        }
    }
    ...
    echo json_encode(array(
        ...
        "@type" => "CollectionPage",
        "name" => "Repuestos y Accesorios para Samsung Galaxy",
        "description" => "Catálogo completo de repuestos y accesorios para smartphones Samsung. Pantallas AMOLED, baterías, cámaras, carcasas y componentes originales y compatibles.",
        "url" => get_permalink(),
...
// Debug: Mostrar información de la consulta si estamos en modo debug
if (defined('WP_DEBUG') && WP_DEBUG) {
    error_log('Samsung Query Args: ' . print_r($args, true));
    error_log('Found Posts: ' . $products_query->found_posts);
    error_log('URL Parameters: ' . print_r($_GET, true));
}
                    ...
                    <div method="get" action="<?php echo esc_url( home_url( '/' ) ); ?>" class="flex flex-col sm:flex-row">
                        ...
                        <div class="flex-1 relative ">
                            ...
                            <input type="text" 
                                   ...
                                   placeholder="Buscar repuestos para Samsung Galaxy por modelo..."
...
<div class="bg-white border-b border-gray-100">
    <div class="w-11/12 py-4 mx-auto 2xl:max-w-[1920px] px-6">
        <nav class="flex items-center space-x-2 text-sm">
            ...
            <span class="text-gray-900 font-semibold">Productos Samsung</span>
        </nav>
    </div>
</div>
            ...
            <div class="flex flex-col lg:flex-row gap-6">
                ...
                <main class="flex-1 w-full xl:w-auto">
                    ...
                    <div class="mt-12">
                        ...
                        function samsung_custom_pagination($query) {
                            if ($query->max_num_pages <= 1) return;
                            
                            $paged = get_query_var('paged') ? absint(get_query_var('paged')) : 1;
                            $max_pages = $query->max_num_pages;
                            
                            // URL base fija para la página de samsung
                            $base_url = home_url('/samsung/');
                        ...
                        samsung_custom_pagination($products_query);
                        ?>
                    </div>

<?php
/**
 * Template Name: Página de Productos Motorola
 * 
 * Template para mostrar productos de motorola
 */

get_header();

// Agregar metadata SEO específica para motorola
add_action('wp_head', function() {
    echo '<meta name="description" content="Repuestos y accesorios para Motorola y Moto G. Pantallas, baterías, cámaras, carcasas y componentes originales y compatibles para reparación de celulares Motorola.">' . "\n";
    echo '<meta name="keywords" content="repuestos motorola, pantalla motorola, bateria motorola, repuestos moto g, accesorios motorola, reparacion motorola, pantalla moto, componentes motorola">' . "\n";
    echo '<meta property="og:title" content="Repuestos y Accesorios para Motorola - ITOOLS">' . "\n";
    echo '<meta property="og:description" content="Encuentra repuestos originales y compatibles para Motorola y Moto G. Pantallas, baterías, cámaras y componentes de calidad">' . "\n";
    ...
    if (has_post_thumbnail()) {
        ...
        if ($thumbnail_url) {
            ...
            echo '<meta property="og:image:alt" content="Repuestos Motorola - ITOOLS">' . "\n";
        }
    }
    ...
    echo json_encode(array(
        ...
        "@type" => "CollectionPage",
        "name" => "Repuestos y Accesorios para Motorola",
        "description" => "Catálogo completo de repuestos y accesorios para smartphones Motorola y Moto G. Pantallas, baterías, cámaras, carcasas y componentes originales y compatibles.",
        "url" => get_permalink(),
...
// Debug: Mostrar información de la consulta si estamos en modo debug
if (defined('WP_DEBUG') && WP_DEBUG) {
    error_log('Motorola Query Args: ' . print_r($args, true));
    error_log('Found Posts: ' . $products_query->found_posts);
    error_log('URL Parameters: ' . print_r($_GET, true));
}
    ...
    <div class="relative max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14 lg:py-16">
        <div class="text-center">
            ...
            <p class="text-lg text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
                Repuestos originales y compatibles para Motorola. Pantallas, baterías, cámaras y accesorios de calidad para smartphones Motorola y Moto G
            </p>
                    ...
                    <div method="get" action="<?php echo esc_url( home_url( '/' ) ); ?>" class="flex flex-col sm:flex-row">
                        ...
                        <div class="flex-1 relative ">
                            ...
                            <input type="text" 
                                   ...
                                   placeholder="Buscar repuestos para Motorola, Moto G por modelo..."
...
<div class="bg-white border-b border-gray-100">
    <div class="w-11/12 py-4 mx-auto 2xl:max-w-[1920px] px-6">
        <nav class="flex items-center space-x-2 text-sm">
            ...
            <span class="text-gray-900 font-semibold">Productos Motorola</span>
        </nav>
    </div>
</div>
            ...
            <div class="flex flex-col lg:flex-row gap-6">
                ...
                <main class="flex-1 w-full xl:w-auto">
                    ...
                    <div class="mt-12">
                        ...
                        function motorola_custom_pagination($query) {
                            if ($query->max_num_pages <= 1) return;
                            
                            $paged = get_query_var('paged') ? absint(get_query_var('paged')) : 1;
                            $max_pages = $query->max_num_pages;
                            
                            // URL base fija para la página de motorola
                            $base_url = home_url('/motorola/');
                        ...
                        motorola_custom_pagination($products_query);
                        ?>
                    </div>

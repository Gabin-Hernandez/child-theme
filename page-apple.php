<?php
/**
 * Template Name: Página de Productos Apple
 * 
 * Template para mostrar productos de apple
 */

get_header();

// Agregar metadata SEO específica para apple
add_action('wp_head', function() {
    echo '<meta name="description" content="Repuestos y accesorios para iPhone y iPad. Pantallas, baterías, cámaras, carcasas y componentes originales y compatibles para reparación de dispositivos Apple.">' . "\n";
    echo '<meta name="keywords" content="repuestos iphone, pantalla iphone, bateria iphone, repuestos ipad, accesorios apple, reparacion iphone, repuestos apple originales, componentes iphone">' . "\n";
    echo '<meta property="og:title" content="Repuestos y Accesorios para iPhone y iPad - ITOOLS">' . "\n";
    echo '<meta property="og:description" content="Encuentra repuestos originales y compatibles para iPhone y iPad. Pantallas, baterías, cámaras y componentes de calidad garantizada">' . "\n";
    ...
    if (has_post_thumbnail()) {
        ...
        if ($thumbnail_url) {
            ...
            echo '<meta property="og:image:alt" content="Repuestos Apple - ITOOLS">' . "\n";
        }
    }
    ...
    echo json_encode(array(
        ...
        "@type" => "CollectionPage",
        "name" => "Repuestos y Accesorios para iPhone y iPad",
        "description" => "Catálogo completo de repuestos y accesorios para dispositivos Apple. Pantallas, baterías, cámaras, carcasas y componentes originales y compatibles para iPhone y iPad.",
        "url" => get_permalink(),
...
// Debug: Mostrar información de la consulta si estamos en modo debug
if (defined('WP_DEBUG') && WP_DEBUG) {
    error_log('Apple Query Args: ' . print_r($args, true));
    error_log('Found Posts: ' . $products_query->found_posts);
    error_log('URL Parameters: ' . print_r($_GET, true));
}
...
<div class="bg-white border-b border-gray-100">
    <div class="w-11/12 py-4 mx-auto 2xl:max-w-[1920px] px-6">
        <nav class="flex items-center space-x-2 text-sm">
            ...
            <span class="text-gray-900 font-semibold">Productos Apple</span>
        </nav>
    </div>
</div>
            ...
            <div class="flex flex-col lg:flex-row gap-6">
                ...
                <main class="flex-1 w-full xl:w-auto">
                    ...
                    <div class="mt-12">
                        ...
                        function apple_custom_pagination($query) {
                            if ($query->max_num_pages <= 1) return;
                            
                            $paged = get_query_var('paged') ? absint(get_query_var('paged')) : 1;
                            $max_pages = $query->max_num_pages;
                            
                            // URL base fija para la página de apple
                            $base_url = home_url('/apple/');
                        ...
                        apple_custom_pagination($products_query);
                        ?>
                    </div>

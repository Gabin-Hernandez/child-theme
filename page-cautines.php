<?php
/**
 * Template Name: Página de Cautines
 * 
 * Template para mostrar productos de cautines
 */

get_header();

// Agregar metadata SEO específica para cautines
add_action('wp_head', function() {
    echo '<meta name="description" content="Cautines y soldadores para reparación de celulares y electrónica. Cautines de precisión, puntas intercambiables, control de temperatura y accesorios para técnicos especializados.">' . "\n";
    echo '<meta name="keywords" content="cautin soldadura, soldador electronico, cautin precision, puntas cautin, soldador temperatura controlada, cautin SMD, herramientas soldadura, cautin reparacion celulares">' . "\n";
    echo '<meta property="og:title" content="Cautines y Soldadores Profesionales - ITOOLS">' . "\n";
    echo '<meta property="og:description" content="Cautines y soldadores de precisión para reparación de celulares. Control de temperatura, puntas especializadas y accesorios profesionales">' . "\n";
    ...
    if (has_post_thumbnail()) {
        ...
        if ($thumbnail_url) {
            ...
            echo '<meta property="og:image:alt" content="Cautines y Soldadores - ITOOLS">' . "\n";
        }
    }
    ...
    echo json_encode(array(
        ...
        "@type" => "CollectionPage",
        "name" => "Cautines y Soldadores Profesionales",
        "description" => "Cautines y soldadores de precisión para reparación de celulares y dispositivos electrónicos. Equipos con control de temperatura, puntas intercambiables y accesorios especializados.",
        "url" => get_permalink(),
...
// Debug: Mostrar información de la consulta si estamos en modo debug
if (defined('WP_DEBUG') && WP_DEBUG) {
    error_log('Cautines Query Args: ' . print_r($args, true));
    error_log('Found Posts: ' . $products_query->found_posts);
    error_log('URL Parameters: ' . print_r($_GET, true));
}
    ...
    <div class="relative max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14 lg:py-16">
        <div class="text-center">
            ...
            <p class="text-lg text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
                Cautines y soldadores profesionales para reparación de celulares. Puntas de precisión, control de temperatura y accesorios especializados
            </p>
                    ...
                    <div method="get" action="<?php echo esc_url( home_url( '/' ) ); ?>" class="flex flex-col sm:flex-row">
                        ...
                        <div class="flex-1 relative ">
                            ...
                            <input type="text" 
                                   ...
                                   placeholder="Buscar cautines por modelo, tipo o características..."
...
<div class="bg-white border-b border-gray-100">
    <div class="w-11/12 py-4 mx-auto 2xl:max-w-[1920px] px-6">
        <nav class="flex items-center space-x-2 text-sm">
            ...
            <span class="text-gray-900 font-semibold">Cautines</span>
        </nav>
    </div>
</div>
            ...
            <div class="flex flex-col lg:flex-row gap-6">
                ...
                <main class="flex-1 w-full xl:w-auto">
                    ...
                    <div class="mt-12">
                        ...
                        function cautines_custom_pagination($query) {
                            if ($query->max_num_pages <= 1) return;
                            
                            $paged = get_query_var('paged') ? absint(get_query_var('paged')) : 1;
                            $max_pages = $query->max_num_pages;
                            
                            // URL base fija para la página de cautines
                            $base_url = home_url('/cautines/');
                        ...
                        cautines_custom_pagination($products_query);
                        ?>
                    </div>

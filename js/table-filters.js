...
(function($) {
    ...
    function filterTable() {
        ...
        console.log('✅ Productos filtrados:', filteredRows.length, 'de', rows.length);
    ...
    function displayPage() {
        ...
        console.log('📄 Mostrando página', currentPage, '| Items:', startIndex, '-', Math.min(endIndex, filteredRows.length));
    }
    ...
    function updatePagination() {
        ...
        if (totalPages > 1) {
            ...
            let paginationHtml = '<nav class="woocommerce-pagination table-pagination mt-8"><ul class="page-numbers flex justify-center gap-2">';
            
            // Botón anterior
            if (currentPage > 1) {
                paginationHtml += '<li><a class="prev page-numbers px-3 py-2 bg-white border border-gray-300 rounded-md hover:bg-gray-50 cursor-pointer" data-page="' + (currentPage - 1) + '">←</a></li>';
            }
            ...
            if (startPage > 1) {
                paginationHtml += '<li><a class="page-numbers px-3 py-2 bg-white border border-gray-300 rounded-md hover:bg-gray-50 cursor-pointer" data-page="1">1</a></li>';
                if (startPage > 2) {
                    paginationHtml += '<li><span class="page-numbers px-3 py-2">...</span></li>';
                }
            }
            
            for (let i = startPage; i <= endPage; i++) {
                if (i === currentPage) {
                    paginationHtml += '<li><span aria-current="page" class="page-numbers current px-3 py-2 bg-blue-600 text-white border border-blue-600 rounded-md">' + i + '</span></li>';
                } else {
                    paginationHtml += '<li><a class="page-numbers px-3 py-2 bg-white border border-gray-300 rounded-md hover:bg-gray-50 cursor-pointer" data-page="' + i + '">' + i + '</a></li>';
                }
            }
            ...
            if (endPage < totalPages) {
                ...
                paginationHtml += '<li><a class="page-numbers px-3 py-2 bg-white border border-gray-300 rounded-md hover:bg-gray-50 cursor-pointer" data-page="' + totalPages + '">' + totalPages + '</a></li>';
            }
            
            // Botón siguiente
            if (currentPage < totalPages) {
                paginationHtml += '<li><a class="next page-numbers px-3 py-2 bg-white border border-gray-300 rounded-md hover:bg-gray-50 cursor-pointer" data-page="' + (currentPage + 1) + '">→</a></li>';
            }
    ...
    function managePaginationVisibility() {
        ...
        const isTableVisible = $('#products-table').is(':visible') && !$('#products-table').hasClass('hidden');

<?php
/**
 * Template Name: Página de Baterías
 * 
 * Template para mostrar productos de baterías de celulares
 */

get_header();

// Agregar metadata SEO específica para baterías de celulares
add_action('wp_head', function() {
    echo '<meta name="description" content="Baterías originales y compatibles para teléfonos celulares. Amplia variedad de baterías de alta calidad para iPhone, Samsung, Huawei, Xiaomi y todas las marcas de smartphones. Garantía y envío rápido.">' . "\n";
    echo '<meta name="keywords" content="baterias celulares, bateria iphone, bateria samsung, bateria huawei, bateria xiaomi, bateria movil, repuestos celulares, baterias originales, baterias compatibles">' . "\n";
    echo '<meta property="og:title" content="Baterías para Celulares - Originales y Compatibles - ITOOLS">' . "\n";
    echo '<meta property="og:description" content="Baterías de alta calidad para todos los modelos de teléfonos celulares. Originales y compatibles con garantía.">' . "\n";
    ...
    if (has_post_thumbnail()) {
        ...
        if ($thumbnail_url) {
            ...
            echo '<meta property="og:image:alt" content="Baterías para Celulares - ITOOLS">' . "\n";
        }
    }
    ...
    echo json_encode(array(
        ...
        "@type" => "CollectionPage",
        "name" => "Baterías para Celulares - Originales y Compatibles",
        "description" => "Baterías de alta calidad para teléfonos celulares de todas las marcas. Baterías originales y compatibles para iPhone, Samsung, Huawei, Xiaomi y más.",
        "url" => get_permalink(),
    ...
    <div class="relative max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14 lg:py-16">
        <div class="text-center">
            ...
            <p class="text-lg text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
                Baterías originales y compatibles de alta calidad para todos los modelos de smartphones. Garantía extendida y envío rápido.
            </p>
                    ...
                    <div method="get" action="<?php echo esc_url( home_url( '/' ) ); ?>" class="flex flex-col sm:flex-row">
                        ...
                        <div class="flex-1 relative ">
                            ...
                            <input type="text" 
                                   ...
                                   placeholder="Buscar baterías por modelo de celular, marca o características..."
...
<div class="bg-white border-b border-gray-100">
    <div class="w-11/12 py-4 mx-auto 2xl:max-w-[1920px] px-6">
        <nav class="flex items-center space-x-2 text-sm">
            ...
            <span class="text-gray-900 font-semibold">Baterías</span>
        </nav>
    </div>
</div>
        ...
        <?php if ( woocommerce_product_loop() ) : ?>
            ...
            <div class="flex flex-col lg:flex-row gap-6">
                ...
                <main class="flex-1 w-full xl:w-auto">
                    ...
                    <div class="mt-12">
                        <?php
                        // Función de paginación específica para página de baterías
                        function baterias_custom_pagination($query) {
                            if ($query->max_num_pages <= 1) return;
                            
                            $paged = get_query_var('paged') ? absint(get_query_var('paged')) : 1;
                            $max_pages = $query->max_num_pages;
                            
                            // URL base fija para la página de baterías
                            $base_url = home_url('/baterias/');
                        ...
                        baterias_custom_pagination($products_query);
                        ?>
                    </div>

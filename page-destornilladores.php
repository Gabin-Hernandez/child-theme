<?php
/**
 * Template Name: Página de Destornilladores
 * 
 * Template para mostrar productos de destornilladores
 */

get_header();

// Agregar metadata SEO específica para destornilladores
add_action('wp_head', function() {
    echo '<meta name="description" content="Destornilladores de precisión para reparación de celulares. Kits completos, puntas intercambiables, destornilladores magnéticos y herramientas profesionales para técnicos especializados.">' . "\n";
    echo '<meta name="keywords" content="destornilladores precision, kit destornilladores, destornillador celular, puntas precision, destornillador magnetico, herramientas reparacion, destornillador iphone, kit herramientas moviles">' . "\n";
    echo '<meta property="og:title" content="Destornilladores de Precisión para Celulares - ITOOLS">' . "\n";
    echo '<meta property="og:description" content="Kits y destornilladores de precisión para reparación de celulares. Puntas intercambiables, magnéticos y herramientas profesionales">' . "\n";
    ...
    if (has_post_thumbnail()) {
        ...
        if ($thumbnail_url) {
            ...
            echo '<meta property="og:image:alt" content="Destornilladores de Precisión - ITOOLS">' . "\n";
        }
    }
    ...
    echo json_encode(array(
        ...
        "@type" => "CollectionPage",
        "name" => "Destornilladores y Kits de Precisión",
        "description" => "Destornilladores de precisión y kits profesionales para reparación de celulares. Herramientas con puntas intercambiables, destornilladores magnéticos y sets completos especializados.",
        "url" => get_permalink(),
...
// Debug: Mostrar información de la consulta si estamos en modo debug
if (defined('WP_DEBUG') && WP_DEBUG) {
    error_log('Destornilladores Query Args: ' . print_r($args, true));
    error_log('Found Posts: ' . $products_query->found_posts);
    error_log('URL Parameters: ' . print_r($_GET, true));
}
    ...
    <div class="relative max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14 lg:py-16">
        <div class="text-center">
            ...
            <p class="text-lg text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
                Destornilladores de precisión y kits profesionales para reparación de celulares. Puntas intercambiables, magnéticos y herramientas especializadas
            </p>
                    ...
                    <div method="get" action="<?php echo esc_url( home_url( '/' ) ); ?>" class="flex flex-col sm:flex-row">
                        ...
                        <div class="flex-1 relative ">
                            ...
                            <input type="text" 
                                   ...
                                   placeholder="Buscar destornilladores, kits o puntas de precisión..."
...
<div class="bg-white border-b border-gray-100">
    <div class="w-11/12 py-4 mx-auto 2xl:max-w-[1920px] px-6">
        <nav class="flex items-center space-x-2 text-sm">
            ...
            <span class="text-gray-900 font-semibold">Destornilladores</span>
        </nav>
    </div>
</div>
            ...
            <div class="flex flex-col lg:flex-row gap-6">
                ...
                <main class="flex-1 w-full xl:w-auto">
                    ...
                    <div class="mt-12">
                        ...
                        function destornilladores_custom_pagination($query) {
                            if ($query->max_num_pages <= 1) return;
                            
                            $paged = get_query_var('paged') ? absint(get_query_var('paged')) : 1;
                            $max_pages = $query->max_num_pages;
                            
                            // URL base fija para la página de destornilladores
                            $base_url = home_url('/destornilladores/');
                        ...
                        destornilladores_custom_pagination($products_query);
                        ?>
                    </div>

...
export function Component() {
  ...
  useEffect(() => {
    ...
    const initApplication = async () => {
        ...
        const slides = [
            { title: "Refacciones Premium", description: "Stock completo de pantallas, baterías y componentes originales para todas las marcas.", media: "https://images.unsplash.com/photo-1604671801908-6f0c6a092c05?w=1920&q=80" },
            { title: "Herramientas Profesionales", description: "Estaciones de soldadura, microscopios y herramientas de precisión para técnicos expertos.", media: "https://images.unsplash.com/photo-1581092918056-0c4c3acd3789?w=1920&q=80" },
            { title: "Pantallas LCD", description: "Amplio catálogo de displays originales para iPhone, Samsung, Huawei y Xiaomi.", media: "https://images.unsplash.com/photo-1556656793-08538906a9f8?w=1920&q=80" },
            { title: "Soluciones Técnicas", description: "Más de 10 años respaldando a profesionales de la reparación en todo México.", media: "https://images.unsplash.com/photo-1621768216002-5ac171876625?w=1920&q=80" },
            { title: "Garantía Certificada", description: "Productos con certificación CE y RoHS. Calidad garantizada en cada componente.", media: "https://images.unsplash.com/photo-1583394838336-acd977736f90?w=1920&q=80" },
            { title: "Envíos Rápidos", description: "Distribución nacional con envíos inmediatos. Tu pedido en tiempo récord.", media: "https://images.unsplash.com/photo-1588508065123-287b28e013da?w=1920&q=80" }
        ];
